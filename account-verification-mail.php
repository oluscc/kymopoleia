<?php
    ...
    $mail->Body    = "<h4>KYMOBUDGET</h4><p>Dear ".$firstname.", please verify your account by clicking <a href='https://testbudgetapp.herokuapp.com/verify-user.php?token=".$token."&email=".$email."'>verify</a></p>";
    if (!$mail->send()) {
